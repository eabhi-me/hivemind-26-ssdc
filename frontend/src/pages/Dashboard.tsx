      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <h3 className="font-display text-2xl font-bold italic uppercase tracking-wider text-cyber-white flex items-center gap-2 m-0">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-2 bg-cyber-pink hover:bg-cyber-pink-bright text-cyber-black font-display font-bold italic tracking-widest clip-chamfer transition-all shadow-[0_0_15px_rgba(255,0,85,0.4)] hover:shadow-[0_0_25px_rgba(255,0,85,0.6)] uppercase shrink-0"
            >
              📄 OFFICIAL BROCHURE
            </a>
          </div>
